System.register([], function (_export, _context) {
  ...
  var _, _t, importMeta, importMeta$1, Foo, myTemplate;
  ...
  return {
    ...
    execute: function () {
      ...
      importMeta = {
        url: new URL('./demo/js/a/b/import-meta-test-2.js', _context.meta.url).href
      };
      window.__importMeta2 = importMeta.url.startsWith(window.location.origin) && importMeta.url.endsWith('/a/b/import-meta-test-2.js');
      importMeta$1 = {
        url: new URL('./demo/js/syntax.js', _context.meta.url).href
      };
      setTimeout(function () {
        _context.import('./legacy-lazy-c0cde729.js');
      }, 1000);
